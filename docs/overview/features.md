...
- 机位拍摄、截图记录和基础镜头管理，支持编辑摄像机位置、注视目标和视野角度，可在摄像机属性或截图列表生成当前机位截图
- 视口比例框、九宫格、平移 / 旋转 / 缩放控制
- 支持角色、我的模型和摄像机的场景树管理，可选中对象并设置可见性、锁定状态及位置、旋转、缩放等属性
- 全景图导入与背景调节，支持场景缩放、平移、旋转、地面、网格、天空颜色和全景背景，以及选择、移动、旋转、缩放等视口操作
...
- 生图工作区支持侧边/底部布局切换、可拖拽工作流入口、参考图上传计数和分类筛选
